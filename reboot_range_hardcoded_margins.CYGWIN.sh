...
#
# Values 'begin' and 'end' are read from hardcoded strings.
# 
...
# Lower IP-address in range
begin="192.168.0.1"
echo "Enter beginning IP address: $begin"

# Higher IP-address in range
end="192.168.0.3"
echo "Enter ending IP address: $end"
